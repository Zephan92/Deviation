...
public class ExchangeServerStarter : MonoBehaviour
{
	#region Unity's inspector

	public HelpBox _header = new HelpBox()
	{
		Text = "Starts the Exchange server if conditions are met.",
	...
	public BmLogger Logger = Msf.Create.Logger(typeof(ExchangeServerStarter).Name);
