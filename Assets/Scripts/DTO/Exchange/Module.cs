...
namespace Assets.Scripts.DTO.Exchange
{
	...
	public class Module : IModule
	{
		...
		private LinkedList<IExchangeAction> _actions;

		//this is the current action on this module
		private LinkedListNode<IExchangeAction> _currentAction;
		...
		public Module(string name, string[] actionNames, ModuleType type, Color moduleTexture, int maxActions)
		{
			...
			_actions = new LinkedList<IExchangeAction>();
			ActionCount = 0;
		...
		private void SetAction(IExchangeAction action)
		{
		...
		public IExchangeAction GetCurrentAction()
		{
